            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full backdrop-blur-sm">
                  ...
                  <span className="text-amber-400 text-sm font-bold uppercase tracking-wider">Welcome Back</span>
                </div>
                ...
                <p className="text-slate-400 text-lg leading-relaxed max-w-md">
                  Access your account and enjoy exclusive premium features designed just for you.
                </p>
              </div>
            ...
            <div className="relative bg-slate-900/90 backdrop-blur-xl border border-slate-800/50 rounded-3xl p-8 lg:p-10 shadow-2xl">
              ...
              <div className="text-center mb-8">
                <div className="mx-auto w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-400/10 flex items-center justify-center mb-5 border border-amber-500/30 shadow-lg shadow-amber-500/20">
                  <FaLock className="text-amber-400 text-3xl" />
                </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      id="remember"
                      className="w-4 h-4 rounded border-2 border-slate-700 bg-slate-900/50 text-amber-500 
                  ...
                  <Link href="/forgot-password" className="text-sm text-amber-400 font-bold hover:text-amber-300 transition-colors">
                    Forgot Password?
                  </Link>
                </div>
